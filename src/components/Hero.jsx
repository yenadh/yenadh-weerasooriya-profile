...
export default function Hero() {
  ...
  const handleDownloadCV = () => {
    ...
    link.href = "/cv/Keshawa_Yenadh_Weerasooriya_CV.pdf"; // <-- put your CV file in public/cv/
    link.download = "Keshawa_Yenadh_Weerasooriya_CV.pdf";
    ...
    >
      ...
      >
        ...
        <div className="relative w-full lg:w-1/2 flex items-center justify-center">
          ...
          >
            <Image
              src="/images/profile-image-yenadh.png"
              alt="Profile photo"
              fill
